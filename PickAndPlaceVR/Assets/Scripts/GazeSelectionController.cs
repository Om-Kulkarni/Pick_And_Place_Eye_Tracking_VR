...
/// 3. Triggers the TrajectoryPlanner to execute the robot's movement.
/// </summary>
///
...
public class GazeSelectionController : MonoBehaviour
{
    ...
    [Tooltip("Reference to the TrajectoryPlanner script in the scene.")]
    public TrajectoryPlanner trajectoryPlanner; // CHANGED
    ...
    private void OnSelectPerformed(InputAction.CallbackContext context)
    {
        ...
        else if (currentState == SelectionState.AwaitingDestination)
        {
            ...
            if (hoveredObject.CompareTag("TargetPlacement"))
            {
                ...
                // Assign our selected objects to the public properties of the Trajectory planner script
                trajectoryPlanner.Target = selectedSource.gameObject;
                trajectoryPlanner.TargetPlacement = selectedDestination.gameObject;

                // Call the method to publish the joints and execute the trajectory.
